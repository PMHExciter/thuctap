...
<div class="col-md-12">
    ...
    <div class="panel panel-primary" style="border:1px solid pink;">
        <div class="panel-heading" style="background: pink;color: black;border:2px solid pink">Orders detail</div>
            ...
            <table class="table table-bordered table-hover">
                ...
                <?php foreach($data as $rows): ?>
                    <?php 
                     ...
                     ?>
                <tr>
                    <td style="text-align: center;"><img src="../assets/upload/products/<?php echo $rows->photo; ?>" style="width:100px;"></td>
