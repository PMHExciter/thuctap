...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../assets/admin/layout1/css/hien.css">
...
<div class="wrapper">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="../assets/admin/layout1/images/01.png" class="user-image" alt="User Image">
                            <span class="hidden-xs">Your name</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="../assets/admin/layout1/images/01.png" class="img-circle" alt="User Image">
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2019-2022 <a href="https://adminlte.io">AdminLTE</a>.</strong> All rights
        reserved.
    </footer>
