	...
	<div class="row">
		<div class="col-md-6 col-md-offset-3">
			<div class="panel panel-primary" style="border:1px solid black">
				<div class="panel-heading" style="background: black;color: white;border:2px solid black;">Login with PMH shop</div>
				<div class="panel-body">
					...
					<div class="row" style="margin-top:5px;">
						...
						<div class="col-md-9"><input type="submit" value="Login" class="btn btn-primary" style="background: black;"> <input type="reset" value="Reset" class="btn btn-danger"></div>
					</div>
					</form>
				</div>
			</div>
